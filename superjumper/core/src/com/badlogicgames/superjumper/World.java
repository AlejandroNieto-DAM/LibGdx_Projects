...
public class World {
	...
	public final List<Squirrel> squirrels;
        public final List<Avion> planes;
	...
	public World (WorldListener listener) {
		...
		this.squirrels = new ArrayList<Squirrel>();
                this.planes = new ArrayList<Avion>();
	...
	private void updateSquirrels (float deltaTime) {
        ...
        private void updatePlanes(float deltaTime) {
		int len = planes.size();
		for (int i = 0; i < len; i++) {
	...
	private void checkSquirrelCollisions () {
        ...
        private void checkPlaneCollisions () {
		int len = planes.size();
		for (int i = 0; i < len; i++) {
			Avion avion = planes.get(i);
			if (avion.bounds.overlaps(bob.bounds)) {
				bob.hitSquirrel();
				listener.hit();
			}
		}
