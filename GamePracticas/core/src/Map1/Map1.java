...
public class Map1 implements Screen {
    ...
    public void setasPositions(){
        positionSetasX.add(12); //POSICION EXACTA DE LA CAJA
        positionSetasY.add(7); //CONTANDO DESDE ABAJO
        
        positionSetasX.add(104);
        positionSetasY.add(9);
        
        positionSetasX.add(158);
